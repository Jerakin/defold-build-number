...
---@field dirty string
---@field format fun()
---@field _get_format fun() private get_format options


local function _get_format(self, options)
...
local function format(self, options)
	local pattern = _get_format(self, options)
